...
void setup() {
  ...
  size(1280, 720,PDF,"bigData.pdf");
  selectedMeaning = -1;
  myScale = 2.2;
  
  Courier = createFont("Courier New Bold",12);
  ACaslon24 = createFont("ACaslonPro-Regular",24);
  ACaslon32 = createFont("ACaslonPro-Regular",32);
  GUI = createFont("ACaslonPro-Bold",10);
  textHeight = 15; 
  noStroke();
...
void draw() {
  ...
  fill(#222222);
  text("A Data Visualization Project by Daniel Mastretta Jimenez. Parsons the new School for Design 2014 // Special Thanks: Gabriel Gianordoli, Gabor Tankovics, Namreta Kumar, Saúl Endara and Matthew Epler.",30,height-20);
  fill(#FFFFFF);
  rect(30,505,230,20);
   fill(#FCFC0F);
  rect(30,535,230,20);
